...
sf = {name: "Suffering Bastard", description: "So many classic cocktails are born in the bars of great hotels. Originally conceived as a hangover cure by the bar staff at Cairo’s Shepherd’s Hotel (before it burned to the ground in 1952), this bourbon- and gin-based drink has been around for 70 years. To adjust the potency—or get a jump on tomorrow’s hangover—simply increase or decrease the amount of ginger ale.",rating: rand(0..5)}
